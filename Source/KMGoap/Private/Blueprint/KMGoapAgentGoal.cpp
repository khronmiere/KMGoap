...
float UKMGoapAgentGoal::Native_GetPriority(const UKMGoapAgentComponent* Agent) const
{
...
float UKMGoapAgentGoal::Priority_Implementation(const UKMGoapAgentComponent* Agent) const
{
